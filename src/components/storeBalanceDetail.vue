<template>
	<div class="body">
		<el-breadcrumb separator-class="el-icon-arrow-right header-title">
			...
			<el-breadcrumb-item :to="{path:'/storeBalanceListDetail?id='+this.$route.query.poiId}">账户详情</el-breadcrumb-item>
		...
		<div class='content'>
			...
			<p>
				<span>交易类型：</span>
				<span>{{allData.tranType==0?"会员充值":"余额充值"}}</span>
			</p>
			<p>
				<span>收支类型：</span>
			...
			<p>
				<span>金额：</span>
				<span>{{allData.payamount}} ({{allData.summary}})</span>
			</p>
			<p>
				<span>交易时间：</span>
